...
const initializeData = async () => {
    ...
    try {
        ...
        const presentaciones = [
            {medicamento:'Hidróxido de Magnesio',forma_farmaceutica:'Susp. Oral', concentracion:'400',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antiácidos'},
            {medicamento:'Hidróxido de Magnesio',forma_farmaceutica:'Susp. Oral', concentracion:'5',u_medida:'ml', cant_u:'', categoria:'Aparato Digestivo', familia:'Antiácidos'},
            {medicamento:'Hidróxido de aluminio',forma_farmaceutica:'Comprimido', concentracion:'500',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antiácidos'},
            {medicamento:'Hidróxido de aluminio',forma_farmaceutica:'Susp. Oral', concentracion:'320',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antiácidos'},
            {medicamento:'Hidróxido de aluminio',forma_farmaceutica:'Susp. Oral', concentracion:'5',u_medida:'ml', cant_u:'', categoria:'Aparato Digestivo', familia:'Antiácidos'},
            {medicamento:'Ondansetrón',forma_farmaceutica:'Comprimido', concentracion:'4',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antieméticos'},
            {medicamento:'Ondansetrón',forma_farmaceutica:'Comprimido', concentracion:'8',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antieméticos'},
            {medicamento:'Ondansetrón',forma_farmaceutica:'Ampolla', concentracion:'8',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antieméticos'},
            {medicamento:'Metoclopramida',forma_farmaceutica:'Ampolla', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antieméticos'},
            {medicamento:'Metoclopramida',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Antieméticos'},
            {medicamento:'Bisacodilo',forma_farmaceutica:'Comprimido', concentracion:'5',u_medida:'mg', cant_u:'', categoria:'Aparato Digestivo', familia:'Laxante'},
            ...
            {medicamento:'Sulfato de Hierro',forma_farmaceutica:'Comprimido', concentracion:'325',u_medida:'mg', cant_u:'', categoria:'Nutriología', familia:'Suplemento Vitamínico'},
            ...
            {medicamento:'Enalapril',forma_farmaceutica:'Comprimido', concentracion:'5',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antihipertensivo'},
            {medicamento:'Enalapril',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antihipertensivo'},
            {medicamento:'Enalapril',forma_farmaceutica:'Comprimido', concentracion:'20',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antihipertensivo'},
            {medicamento:'Losartán',forma_farmaceutica:'Comprimido', concentracion:'25',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antihipertensivo'},
            {medicamento:'Losartán',forma_farmaceutica:'Comprimido', concentracion:'50',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antihipertensivo'},
            {medicamento:'Losartán',forma_farmaceutica:'Comprimido', concentracion:'100',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antihipertensivo'},
            {medicamento:'Nitroglicerina',forma_farmaceutica:'Comprimido', concentracion:'0.3',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antianginoso'},
            {medicamento:'Nitroglicerina',forma_farmaceutica:'Comprimido', concentracion:'0.4',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antianginoso'},
            {medicamento:'Nitroglicerina',forma_farmaceutica:'Comprimido', concentracion:'0.6',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antianginoso'},
            ...
            {medicamento:'Isosorbida dinitrato',forma_farmaceutica:'Comprimido', concentracion:'5',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antianginoso'},
            {medicamento:'Isosorbida dinitrato',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antianginoso'},
            {medicamento:'Isosorbida dinitrato',forma_farmaceutica:'Comprimido', concentracion:'20',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antianginoso'},
            {medicamento:'Isosorbida dinitrato',forma_farmaceutica:'Comprimido', concentracion:'40',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Antianginoso'},
            ...
            {medicamento:'Warfarina',forma_farmaceutica:'Comprimido', concentracion:'1',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Warfarina',forma_farmaceutica:'Comprimido', concentracion:'2',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Warfarina',forma_farmaceutica:'Comprimido', concentracion:'2.5',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Warfarina',forma_farmaceutica:'Comprimido', concentracion:'5',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Warfarina',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Enoxaparina',forma_farmaceutica:'Ampolla', concentracion:'30',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Enoxaparina',forma_farmaceutica:'Ampolla', concentracion:'40',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Enoxaparina',forma_farmaceutica:'Ampolla', concentracion:'60',u_medida:'mg', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Enoxaparina',forma_farmaceutica:'Ampolla', concentracion:'0.3',u_medida:'ml', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Enoxaparina',forma_farmaceutica:'Ampolla', concentracion:'0.4',u_medida:'ml', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Enoxaparina',forma_farmaceutica:'Ampolla', concentracion:'0.6',u_medida:'ml', cant_u:'', categoria:'Cardiovascular', familia:'Anticoagulante'},
            {medicamento:'Paracetamol',forma_farmaceutica:'Comprimido', concentracion:'325',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Analgésico'},
            {medicamento:'Paracetamol',forma_farmaceutica:'Comprimido', concentracion:'500',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Analgésico'},
            {medicamento:'Paracetamol',forma_farmaceutica:'Comprimido', concentracion:'650',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Analgésico'},
            ...
            {medicamento:'Ibuprofeno',forma_farmaceutica:'Comprimido', concentracion:'200',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Analgésico'},
            {medicamento:'Ibuprofeno',forma_farmaceutica:'Comprimido', concentracion:'400',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Analgésico'},
            {medicamento:'Ibuprofeno',forma_farmaceutica:'Comprimido', concentracion:'600',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Analgésico'},
            {medicamento:'Ibuprofeno',forma_farmaceutica:'Comprimido', concentracion:'800',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Analgésico'},
            ...
            {medicamento:'Fluoxetina',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Fluoxetina',forma_farmaceutica:'Comprimido', concentracion:'20',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Fluoxetina',forma_farmaceutica:'Comprimido', concentracion:'40',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Amitriptilina',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Amitriptilina',forma_farmaceutica:'Comprimido', concentracion:'25',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Amitriptilina',forma_farmaceutica:'Comprimido', concentracion:'50',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Amitriptilina',forma_farmaceutica:'Comprimido', concentracion:'75',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Amitriptilina',forma_farmaceutica:'Comprimido', concentracion:'100',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Amitriptilina',forma_farmaceutica:'Comprimido', concentracion:'125',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Amitriptilina',forma_farmaceutica:'Comprimido', concentracion:'150',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antidepresivo'},
            {medicamento:'Carbamazepina',forma_farmaceutica:'Comprimido', concentracion:'200',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antiepiléptico'},
            {medicamento:'Carbamazepina',forma_farmaceutica:'Comprimido', concentracion:'100',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antiepiléptico'},
            {medicamento:'Carbamazepina',forma_farmaceutica:'Susp. Oral', concentracion:'5',u_medida:'ml', cant_u:'', categoria:'Sistema Nervioso', familia:'Antiepiléptico'},
            ...
            {medicamento:'Valproato de sodio',forma_farmaceutica:'Ampolla', concentracion:'250',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antiepiléptico'},
            {medicamento:'Valproato de sodio',forma_farmaceutica:'Ampolla', concentracion:'500',u_medida:'mg', cant_u:'', categoria:'Sistema Nervioso', familia:'Antiepiléptico'},
            ...
            {medicamento:'Loratadina',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Aparato Respiratorio', familia:'Antihistamínicos'},
            ...
            {medicamento:'Cetirizina',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Aparato Respiratorio', familia:'Antihistamínicos'},
            ...
            {medicamento:'Codeína',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Aparato Respiratorio', familia:'Antitusivo'},
            {medicamento:'Codeína',forma_farmaceutica:'Comprimido', concentracion:'5',u_medida:'ml', cant_u:'', categoria:'Aparato Respiratorio', familia:'Antitusivo'},
            ...
            {medicamento:'Metformina',forma_farmaceutica:'Comprimido', concentracion:'500',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Antidiabético'},
            {medicamento:'Metformina',forma_farmaceutica:'Comprimido', concentracion:'850',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Antidiabético'},
            {medicamento:'Metformina',forma_farmaceutica:'Comprimido', concentracion:'1000',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Antidiabético'},
            {medicamento:'Insulina',forma_farmaceutica:'Ampolla', concentracion:'0',u_medida:'U/ml', cant_u:'', categoria:'Sistema Endocrino', familia:'Antidiabético'},
            {medicamento:'Levotiroxina',forma_farmaceutica:'Comprimido', concentracion:'25',u_medida:'mcg', cant_u:'', categoria:'Sistema Endocrino', familia:'Hormona Tiroidea'},
            {medicamento:'Levotiroxina',forma_farmaceutica:'Comprimido', concentracion:'50',u_medida:'mcg', cant_u:'', categoria:'Sistema Endocrino', familia:'Hormona Tiroidea'},
            {medicamento:'Levotiroxina',forma_farmaceutica:'Comprimido', concentracion:'75',u_medida:'mcg', cant_u:'', categoria:'Sistema Endocrino', familia:'Hormona Tiroidea'},
            {medicamento:'Levotiroxina',forma_farmaceutica:'Comprimido', concentracion:'100',u_medida:'mcg', cant_u:'', categoria:'Sistema Endocrino', familia:'Hormona Tiroidea'},
            {medicamento:'Levotiroxina',forma_farmaceutica:'Comprimido', concentracion:'125',u_medida:'mcg', cant_u:'', categoria:'Sistema Endocrino', familia:'Hormona Tiroidea'},
            {medicamento:'Levotiroxina',forma_farmaceutica:'Comprimido', concentracion:'150',u_medida:'mcg', cant_u:'', categoria:'Sistema Endocrino', familia:'Hormona Tiroidea'},
            {medicamento:'Prednisona',forma_farmaceutica:'Comprimido', concentracion:'1',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Prednisona',forma_farmaceutica:'Comprimido', concentracion:'5',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Prednisona',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Prednisona',forma_farmaceutica:'Comprimido', concentracion:'20',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Prednisona',forma_farmaceutica:'Comprimido', concentracion:'50',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Comprimido', concentracion:'1',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Comprimido', concentracion:'5',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Comprimido', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Comprimido', concentracion:'20',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Comprimido', concentracion:'50',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Ampolla', concentracion:'1',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Ampolla', concentracion:'5',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Ampolla', concentracion:'10',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Ampolla', concentracion:'20',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Dexametasona',forma_farmaceutica:'Ampolla', concentracion:'50',u_medida:'mg', cant_u:'', categoria:'Sistema Endocrino', familia:'Corticosteroide'},
            {medicamento:'Amoxicilina',forma_farmaceutica:'Comprimido', concentracion:'250',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antibiótico'},
            {medicamento:'Amoxicilina',forma_farmaceutica:'Comprimido', concentracion:'500',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antibiótico'},
            ...
            {medicamento:'Ciprofloxacino',forma_farmaceutica:'Comprimido', concentracion:'250',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antibiótico'},
            {medicamento:'Ciprofloxacino',forma_farmaceutica:'Comprimido', concentracion:'500',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antibiótico'},
            {medicamento:'Ciprofloxacino',forma_farmaceutica:'Comprimido', concentracion:'750',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antibiótico'},
            {medicamento:'Aciclovir',forma_farmaceutica:'Comprimido', concentracion:'200',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antiviral'},
            {medicamento:'Aciclovir',forma_farmaceutica:'Comprimido', concentracion:'400',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antiviral'},
            {medicamento:'Aciclovir',forma_farmaceutica:'Comprimido', concentracion:'800',u_medida:'mg', cant_u:'', categoria:'Infecciones', familia:'Antiviral'},
            ...
            {medicamento:'Nistatina',forma_farmaceutica:'Susp. Oral', concentracion:'100000',u_medida:'U/ml', cant_u:'', categoria:'Infecciones', familia:'Antifúngico'},
            ...
            {medicamento:'Metotrexato',forma_farmaceutica:'Comprimido', concentracion:'25',u_medida:'mg', cant_u:'', categoria:'Sistema Inmunológico', familia:'Inmunosupresor'},
            {medicamento:'Metotrexato',forma_farmaceutica:'Ampolla', concentracion:'2.5',u_medida:'mg', cant_u:'', categoria:'Sistema Inmunológico', familia:'Inmunosupresor'},
            {medicamento:'Interferón alfa',forma_farmaceutica:'Ampolla', concentracion:'3',u_medida:'MIU', cant_u:'', categoria:'Sistema Inmunológico', familia:'Inmunoestimulante'},
            {medicamento:'Interferón alfa',forma_farmaceutica:'Ampolla', concentracion:'6',u_medida:'MIU', cant_u:'', categoria:'Sistema Inmunológico', familia:'Inmunoestimulante'}
        ];
